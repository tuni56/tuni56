...
* Streaming Systems with Apache Kafka
* Generative AI Solutions for Data Operations
* Data Lakes and Data Warehouses on AWS
* Infrastructure as Code with Terraform
* Reliable, Observable, and Cost-Efficient Systems
...
* Co-Leader, AWS Girls Argentina
* Technical Speaker across AWS, Google Cloud, university, and technology communities in Latin America
* Speaker on Event-Driven Architectures, Cloud Data Platforms, Resilience, and AI for Data Operations
...
* Veeam EmpowerHer Scholar
* EPAM Cloud Platform Engineer Specialization Program
